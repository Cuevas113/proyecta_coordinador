        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end" id="sidebar-wrapper" >
              ...
              <div class="list-group list-group-flush">
                  ...
                  <a class="list-group-item list-group-item-action list-group-item-light p-3 fs-5 navbar-botones" href="#!" ><i class="bi bi-grid-1x2"></i> Frentes</a>
                  <a class="list-group-item list-group-item-action list-group-item-light p-3 fs-5 navbar-botones" href="#!" ><i class="bi bi-person-badge"></i> Paramédicos</a>
              </div>
              <br>
              <h3 class="m-2">Asignaciones</h3>
              <div class="list-group list-group-flush">
                  <a class="list-group-item list-group-item-action list-group-item-light p-3 fs-5 navbar-botones" href="#!" style=""><i class="bi bi-person-lines-fill"></i> Frentes</a>
                      ...
                      <div class="col-12 col-xl-4 fs-5">
                        ...
                        <form class="row m-2">
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-2">
                            <input type="hidden" name="" value="<?php echo $id; ?>" id="usuario">
                            <label for="nombreCues" class="form-label">Nombres de contrato</label>
                            <input type="text" class="form-control input-color" id="nombreCues" placeholder="" autocomplete="off" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-2">
                            <label for="nombreCues" class="form-label">Contrato</label>
                            <input type="text" class="form-control input-color" id="nombreCues" placeholder="" autocomplete="off" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-2">
                            <label for="nombreCues" class="form-label">Nombre del contrato (Proyecto)</label>
                            <input type="text" class="form-control input-color" id="nombreCues" placeholder="" autocomplete="off" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 m-2 text-center">
                            <button type="button" class="btn button-form" id="users"> <i class="bi bi-send"></i> Guardar contrato</button>
                          </div>
                        </form>
                      </div>
