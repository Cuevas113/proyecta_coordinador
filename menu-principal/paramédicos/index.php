        ...
        <div class="d-flex" id="wrapper" >
            ...
            <div class="border-end" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 fs-5 navbar-botones navbar" href="" ><i class="bi bi-person-badge"></i> Paramédicos</a>
                </div>
                <br>
            ...
            <div id="page-content-wrapper" class="cuerpo">
                ...
                <div class="container-fluid">
                    <div class="row">
                      <div class="col-12 col-xl-4 fs-5" id="form">
                        <h4 class="m-3">Paramédico</h4>
                        <form class="row m-2">
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            <input type="hidden" name="" value="" id="frenteID" value="nuevo">
                            <label for="nombreFrente" class="form-label">Nombres</label>
                          ...
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            <label for="nombreFrente" class="form-label">Apellidos</label>
                            <input type="text" class="form-control input-color" id="nombreFrente" name="nombreFrente" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            <label for="frenteObrero" class="form-label">Agregue Frentes</label>
                            <select class="form-select input-color js-example-basic-multiple" name="paraFrente[]" id="frenteObrero" multiple="multiple">
                                <option value="1">Frente 1...</opcion>
                                <option value="2">Frente 2...</opcion>
                                <option value="3">Frente 3...</opcion>
                            </select>
                          </div>


                          <div class="col-12 col-md-12 col-lg-6 col-xl-4">
                            <label for="nombreFrente" class="form-label">Edad</label>
                            <input type="number" class="form-control input-color" id="nombreFrente" name="nombreFrente" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 col-md-12 col-lg-6 col-xl-8">
                            <label for="nombreFrente" class="form-label">Fecha de nacimiento</label>
                            <input type="date" class="form-control input-color" id="nombreFrente" name="nombreFrente" autocomplete="off">
                          </div>

                          <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                            <label for="frenteTurno" class="form-label">Identificación</label>
                          ...
                          <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                            <label for="frenteSeguridad" class="form-label">Cargo</label>
                          ...
                          <div class="col-12 m-2 text-center">
                            <button type="button" class="btn button-form" id="guardarPara"> <i class="bi bi-send"></i> Guardar paramédico</button>
                          </div>
                        </form>
                      </div>
                      <div class="col-12 col-xl-8">
                        <h4 class="m-3">Personal</h4>
                          ...
                          <table class="table table-hover table-striped" id="tableContenido">
                            <thead class="titulo-tabla">
                              <tr>
                                ...
                                <th scope="col d-flex justify-content-center">Numbero</th>
                                <th scope="col d-flex justify-content-center">Frentes</th>
