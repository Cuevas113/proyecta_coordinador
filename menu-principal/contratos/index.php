        ...
        <div class="d-flex" id="wrapper" >
            ...
            <div class="border-end" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 fs-5 navbar-botones navbar" href=""><i class="bi bi-clipboard2"></i> Contratos</a>
                ...
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 fs-5 navbar-botones" href="../asignar-frentes/" style=""><i class="bi bi-person-lines-fill"></i> Frentes</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                      <div class="col-12 col-xl-4 fs-5">
                        <h4 class="m-3">Nuevo Contrato</h4>
                        <form class="row m-2">
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-2">
                            <input type="hidden" name="" value="" id="contratoID" value="nuevo">
                            <label for="nombreContrato" class="form-label">Nombres de contrato</label>
                            <input type="text" class="form-control input-color" id="nombreContrato" name="nombreContrato" placeholder="" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-2">
                            <label for="numeroContrato" class="form-label">Contrato</label>
                            <input type="text" class="form-control input-color" id="numeroContrato" name="numeroContrato" placeholder="" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-2">
                            <label for="proyectoContrato" class="form-label">Nombre del contrato (Proyecto)</label>
                            <input type="text" class="form-control input-color" id="proyectoContrato" name="proyectoContrato" placeholder="" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          </div>
                          <div class="col-12 m-2 text-center">
                            <button type="button" class="btn button-form" id="guardarContrato"> <i class="bi bi-send"></i> Guardar contrato</button>
                          </div>
                        </form>
                      </div>
                      <div class="col-12 col-xl-8">
                        <h4 class="m-3">Contratos Disponibles</h4>
                          ...
                          <table class="table table-hover table-striped" id="tableContenido">
                            <thead class="titulo-tabla">
                              <tr>
                                ...
                                <th scope="col d-flex justify-content-center">Numero de contrato</th>
                                <th scope="col d-flex justify-content-center">Contrato</th>
                                <th scope="col d-flex justify-content-center">Proyecto</th>
